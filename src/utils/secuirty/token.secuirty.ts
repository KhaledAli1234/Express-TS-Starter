...
export const getSignature = async (
  ...
  if (signatureLevel === SignatureLevelEnum.system) {
    return {
      access_signature: process.env.ACCESS_SYSTEM_TOKEN_SIGNATURE as string,
      refresh_signature: process.env.REFRESH_SYSTEM_TOKEN_SIGNATURE as string,
    };
  }
  return {
