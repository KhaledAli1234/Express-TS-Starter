...
export const freezeAccount = {
  params: z
    ...
    .optional()
    .refine(
      (data) => (data?.userId ? Types.ObjectId.isValid(data.userId) : true),
      {
...
export const restoreAccount = {
  params: z
    ...
    .refine((data) => Types.ObjectId.isValid(data.userId), {
      error: "invalid objectId format",
      path: ["userId"],
    }),
};
...
export const changeRole = {
  params: z.strictObject({ userId: generalFields.id }),
  body: z.strictObject({ role: z.enum(RoleEnum) }),
};
